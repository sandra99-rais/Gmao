...
public class AnalysePanne extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyse_panne);
        ...
        navigationView.setCheckedItem(R.id.analyse);
         //****************************Fin Menu**************************************/
        Cursor Allpanne2=db.AlltypePanne();

        Pie pie1 = AnyChart.pie();

        List<DataEntry> panne2 = new ArrayList<>();
        while (Allpanne2.moveToNext() && Allpanne2.getInt(0) != 0)
        {
            Cursor CountPanne=db.countTypePanne(Allpanne2.getInt(0));

            while (CountPanne.moveToNext() && CountPanne.getInt(0) != 0)
            {
                panne2.add(new ValueDataEntry(Allpanne2.getString(1), CountPanne.getInt(0) ));
        ...
        pie1.title("Répartition par panne");
